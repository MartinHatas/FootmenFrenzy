...
public class TerrainTrackControl extends AbstractControl{
    ...
    public TerrainTrackControl(Spatial terrain) {
    ...
    private boolean isTerrain(Spatial spat) {
        while (true) {
            if (spat == null) {
                return false;
            } else if ("terrain-footmen_frenzy_map".equals(spat.getName())) {
                return true;
            }
            spat = spat.getParent();
        }
    ...
    public Control cloneForSpatial(Spatial spatial) {
        TerrainTrackControl control = new TerrainTrackControl(terrain);
